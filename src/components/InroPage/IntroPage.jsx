...
export default function IntroPage(){
    ...
    return(
        <div className="relative flex flex-col w-screen min-h-[150dvh] pb-[200px] bg-[#0E0E0D]">
            
            <div className=" relative h-fit w-fit ml-32 mt-16">
                <HeadingBig content='Intro' size={144} width='auto' />
            </div>

            <div className=' relative flex flex-row-reverse justify-between items-center mt-[180px]  mx-[124px] m-auto text-white '>
                {/* BIG PARA IN INTRO SECTION */}
                <div className='relative  w-[500px] flex flex-col justify-between text-left'>
